...
paru -Syu && paru -S \
    ...
    gnome-keyring xdg-desktop-portal-gnome qt5-wayland qt6-wayland \
...
# Setup Gnome's xdg-desktop-portal for Niri
sudo cp ./niri-portals.conf /usr/share/xdg-desktop-portal/
